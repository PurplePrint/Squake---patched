...
@Mod(modid = ModInfo.MODID, version = ModInfo.VERSION, name="Squake", acceptedMinecraftVersions="[1.12.2]", dependencies = "after:squeedometer;after:techguns;after:openglider", guiFactory = ModInfo.CONFIG_GUI_FACTORY_CLASS)
public class ModQuakeMovement
{

	public static boolean techgunsIntegration = false;
	public static boolean openGliderIntegration = false;
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		openGliderIntegration = Loader.isModLoaded("openglider");
...
//			MinecraftForge.EVENT_BUS.register(new FairplayPatch());
//		}
	}
